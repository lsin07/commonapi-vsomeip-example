...
if [ "$1" = "--external" ]; then
    CONFIG=configs/config_service.json
    ...
    COMMONAPI_CONFIG=commonapi4someip.ini LD_LIBRARY_PATH=../install_folder/lib:$PWD/build/ VSOMEIP_CONFIGURATION=$CONFIG build/HelloWorldService
else
